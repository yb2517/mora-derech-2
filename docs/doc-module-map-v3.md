...
סטטוס: גרסה 3.6, מאושרת 14.09.2026. גרסה 1 אושרה 11.09.2026; גרסה 2 (DESIGN-01 והמיפוי שורה לשורה) לא הובאה לאישור בנפרד ונבלעה בגרסה 3, שאושרה 12.09.2026.
תאריך: 12.09.2026
...
| SESSIONS (הסשן) | session_id (אקראי), site_id, started_at, ended_at, completed, last_stop_id, flags (no_location, no_hebrew_voice, simulator, partial_log, low_battery_warned, ended_on_battery, ended_on_battery_block), previous_session_id | open, closed | open ל-closed: BE-07, בפעולת session_end של screen-traveler, בהגעה לנקודה האחרונה, או ב-close_stale של system-timer. חידוש אחרי טעינה (הוכרע 14.09.2026): סשן פתוח של המסלול ממשיך באותו session_id, ו-BE-07 מוצא אותו בנתונים; סשן שנסגר פותח סשן חדש עם previous_session_id שמצביע עליו. המסך אינו מחזיק את המזהה באחסון, מפני שרק CORE-04 נוגע באחסון |
...
ההכרעות 1 עד 20 של גרסה 2 הוכרעו ב-12.09.2026 (decision-04 ו-doc-decision-round-01 חלקים א עד ד) ונקלטו לאורך המסמך. הכרעה 5 (חידוש הסשן אחרי טעינה) הוכרעה ב-14.09.2026 בסוף שלב 4 ונקלטה בשורת SESSIONS בסעיף 2.1, ולכן ירדה מהטבלה. המספור אינו ממוחזר: מספר שנגרע אינו ניתן להכרעה אחרת. מה שנשאר:
